...
public class Demo extends Frame  implements ActionListener,ItemListener,AdjustmentListener{ 
  Button b1,b2,b3,b4;
  Checkbox c1,c2,c3;
  Choice ch;
  Scrollbar sc;
...
public void actionPerformed(ActionEvent e){
  ...
  public void paint(Graphics g){
      ...
      g.drawString("satyam", 50, 400);
   
    g.drawString("bold "+c1.getState(), 50, 420);
